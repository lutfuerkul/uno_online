...
Future<bool> confirmLeaveUnoGame(BuildContext context) async {
  final confirmed = await showDialog<bool>(
    context: context,
    builder: (ctx) => AlertDialog(
      backgroundColor: UnoColors.topbar,
      title: const Text('Oyundan çık?', style: TextStyle(color: Colors.white)),
      content: const Text(
        'Oyundan çıkmak istediğine emin misin?',
        style: TextStyle(color: UnoColors.muted),
      ),
      actions: [
        TextButton(
        ...
        TextButton(
          ...
          style: TextButton.styleFrom(foregroundColor: UnoColors.error),
